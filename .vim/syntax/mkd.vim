...
"HTML headings
syn region htmlH1       start="^\s*#"                   end="\($\|#\+\)"
syn region htmlH2       start="^\s*##"                  end="\($\|#\+\)"
syn region htmlH3       start="^\s*###"                 end="\($\|#\+\)"
syn region htmlH4       start="^\s*####"                end="\($\|#\+\)"
syn region htmlH5       start="^\s*#####"               end="\($\|#\+\)"
syn region htmlH6       start="^\s*######"              end="\($\|#\+\)"
syn match  htmlH1       /^.\+\n=\+$/
syn match  htmlH2       /^.\+\n-\+$/
